...
class HabAutoPage extends StatefulWidget {
  ...
  @override
  State<HabAutoPage> createState() => _HabAutoPage();
}

class _HabAutoPage extends State<HabAutoPage> {
        ...
        children: [
          StreamBuilder<List<String>>(
              stream: dbService.getSuggestedHabitLawActions(
                  widget.habitName, "MakeItEasy", "HabitAutomation"),
  ...
  void saveHabitLaw(BuildContext context, String habitStr) async {
    ...
    final String habitLawNum = "Habit Automation";
