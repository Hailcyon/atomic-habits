...
class CustomizeSaveHabitScreen extends StatelessWidget {
                ...
                child: Column(children: [
                  ...
                  Padding(
                      ...
                      child: Row(
                          ...
                          children: [
                            _buildFortyEightIcon(context),
                            _buildFortyEightGoForARun(context)
                          ])),
                  ...
                  _buildResultButton1(context),
                  SizedBox(height: 16.v),
                  _buildResultButton2(context),
                  ...
                  Align(
                      ...
                      child: Padding(
                          ...
                          child: Text("lbl_or".tr,
                              style: CustomTextStyles.titleLargeMontserrat))),
                  SizedBox(height: 28.v),
                  _buildSearchForAHabitButton(context),
  ...
  /// Section Widget
  Widget _buildFortyEightIcon(BuildContext context) {
    return BlocSelector<CustomizeSaveHabitBloc, CustomizeSaveHabitState,
            TextEditingController?>(
        selector: (state) => state.fortyEightIconController,
        builder: (context, fortyEightIconController) {
          return CustomTextFormField(
              width: 59.h,
              controller: fortyEightIconController,
              suffix: Container(
  ...
  /// Section Widget
  Widget _buildFortyEightGoForARun(BuildContext context) {
    return Expanded(
        child: Padding(
            padding: EdgeInsets.only(left: 26.h),
            child: BlocSelector<CustomizeSaveHabitBloc, CustomizeSaveHabitState,
                    TextEditingController?>(
                selector: (state) => state.fortyEightGoForARunController,
                builder: (context, fortyEightGoForARunController) {
                  return CustomTextFormField(
                      controller: fortyEightGoForARunController,
  ...
  /// Section Widget
  Widget _buildFortyNineFour(BuildContext context) {
    return CustomOutlinedButton(width: 38.h, text: "lbl_4".tr);
  }

  /// Section Widget
  Widget _buildFortyNineSix(BuildContext context) {
  ...
  /// Section Widget
  Widget _buildResultButton1(BuildContext context) {
    return CustomElevatedButton(
        text: "lbl_result".tr, buttonStyle: CustomButtonStyles.fillYellow);
  }

  /// Section Widget
  Widget _buildResultButton2(BuildContext context) {
    return CustomElevatedButton(
        text: "lbl_result".tr, buttonStyle: CustomButtonStyles.fillYellow);
  }

  /// Section Widget
  Widget _buildSearchForAHabitButton(BuildContext context) {
    return CustomElevatedButton(
        text: "msg_search_for_a_habit".tr,
        buttonTextStyle: CustomTextStyles.headlineMediumAmber200,
        onPressed: () {
          onTapSearchForAHabitButton(context);
        });
  }
  ...
  onTapSearchForAHabitButton(BuildContext context) {
    NavigatorService.pushNamed(
