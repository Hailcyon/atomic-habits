...
class NewHabitSearchScreen extends StatelessWidget {
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  _buildSearchResultButton1(context),
                  SizedBox(height: 16.v),
                  _buildSearchResultButton2(context),
                  SizedBox(height: 16.v),
                  _buildSearchResultButton3(context),
                  Spacer(),
                  Text("msg_not_what_you_re".tr,
                      style: CustomTextStyles.titleLargeMontserrat),
                  SizedBox(height: 25.v),
                  _buildCreateCustomHabitButton(context),
  ...
  Widget _buildSearchEditText(BuildContext context) {
    return BlocSelector<NewHabitSearchBloc, NewHabitSearchState,
        ...
        selector: (state) => state.searchEditTextController,
        builder: (context, searchEditTextController) {
  ...
  /// Section Widget
  Widget _buildSearchResultButton1(BuildContext context) {
    return CustomElevatedButton(
        text: "lbl_result".tr, buttonStyle: CustomButtonStyles.fillYellow);
  }

  /// Section Widget
  Widget _buildSearchResultButton2(BuildContext context) {
    return CustomElevatedButton(
        text: "lbl_result".tr, buttonStyle: CustomButtonStyles.fillYellow);
  }

  /// Section Widget
  Widget _buildSearchResultButton3(BuildContext context) {
    return CustomElevatedButton(
        text: "lbl_result".tr, buttonStyle: CustomButtonStyles.fillYellow);
  }

  /// Section Widget
  Widget _buildCreateCustomHabitButton(BuildContext context) {
    return CustomElevatedButton(
        text: "msg_create_a_custom".tr,
        buttonTextStyle: CustomTextStyles.headlineMediumAmber200,
        onPressed: () {
          onTapCreateCustomHabitButton(context);
        });
  }
  ...
  onTapCreateCustomHabitButton(BuildContext context) {
    NavigatorService.pushNamed(
